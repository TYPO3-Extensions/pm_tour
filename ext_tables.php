...
$TCA["tx_pmtour_tour"] = Array (
	...
	"feInterface" => Array (
		"fe_admin_fieldList" => "sys_language_uid, l18n_parent, l18n_diffsource, hidden, starttime, endtime, fe_group, name, description, number, length_km, duration_h, images, gpxfile, displaytype, region, showfilter, showaltitudeprofile",
	)
);
